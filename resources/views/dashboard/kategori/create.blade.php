        ...
        <form method="post" action="/dashboard/kategori" class="mb-5" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('kode_kategori') is-invalid @enderror" 
                  id="kode_kategori" name="kode_kategori" required value="{{old('kode_kategori')}}">
              @error('kode_kategori')
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nama_kategori') is-invalid @enderror" 
                    id="nama_kategori" name="nama_kategori" required value="{{old('nama_kategori')}}">
            @error('nama_kategori')
              <div class="invalid-feedback">
                <h5>{{ $message }}</h5>
              </div>
          ...
          <div class="mb-3">
            <label for="deskripsi_kategori" class="form-label">Deskripsi Buku</label>
            @error('deskripsi_kategori')
            <p class="text-danger">{{$message}}</p>
            @enderror
            <input id="deskripsi_kategori" type="hidden" name="deskripsi_kategori" value="{{old('deskripsi_kategori')}}">
